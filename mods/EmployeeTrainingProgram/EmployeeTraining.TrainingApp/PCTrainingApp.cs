...
public class PCTrainingApp : MonoBehaviour
{
	...
	private void ComposeBasePanel(GameObject panelObj)
	{
		...
		val16.SetupObject(new Vector3(15f, -58f, 0f), new Vector2(280f, 12f), new Vector2(0f, 1f));
		...
		val18.SetupText(new Vector3(0f, 0f, 0f), new Vector2(200f, 11f), 8f, (HorizontalAlignmentOptions)1, new Color(1f, 1f, 1f, 0.92f), new Vector2(0f, 1f), "Mastery Roadmap");
		TextMeshProUGUI roadmapTitle = val18.GetComponent<TextMeshProUGUI>();
		((TMP_Text)roadmapTitle).characterSpacing = 0.6f;
		((TMP_Text)roadmapTitle).verticalAlignment = VerticalAlignmentOptions.Middle;
		UIHelper.CreateSoftDivider(val16.transform, new Vector3(140f, -10f, 0f), 280f);
		...
		val19.SetupObject(new Vector3(15f, -68f, 0f), (Vector2?)new Vector2(-15f, 35f), (Vector2?)null);
		float num = 54f;
		...
		foreach (Grade grade in list)
		{
			...
			UIHelper.SetupText(pos: new Vector3(0f, -1f, 0f), size: new Vector2(num - 5f, 11f), pivot: (Vector2?)new Vector2(0.5f, 1f), obj: val22, fontsize: 8.5f, align: (HorizontalAlignmentOptions)2, color: (Color?)(Color32)(grade.Color), key: grade.Name, args: (string[])null);
			GameObject val23 = ComposeSlider(val21, "Slider", new Vector3(0f, -14f, 0f), val20, (Color32)(grade.Color));
			...
			val25.SetupObject(new Vector3(0f, -14f, 0f));
